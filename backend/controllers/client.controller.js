...
const getAllClients = async (req, res) => {
    try {
        ...
        const {
            ...
            "filters[partyLegalEntityRegistrationName][$containsi]": nameFilter,
...
const createClient = async (req, res) => {
    ...
    try {
        ...
        if (!partyLegalEntityRegistrationName || !countryIdentificationCode ||
            !partyTaxSchemeCompanyID || !partyTaxSchemeTaxSchemeId) {
